...
这是 Writer 最重要的长期价值。每次用户编辑文章后让系统学习，下一版的初稿就会更接近用户的风格，需要的编辑量越来越少。
...
- **final**：用户提供修改后的版本。主动引用："请把你改好的文章全文粘贴给我，或告诉我文件路径。如果你是在微信后台编辑器里改的，可以全选复制后直接粘贴到这里。"
